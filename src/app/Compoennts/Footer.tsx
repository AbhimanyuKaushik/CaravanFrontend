...
function Footer() {
    return (
        <div className='footer mt-[100px] text-[#d9d9d9] bg-[#323232] flex flex-col items-center gap-[20px] pt-[80px]' id='footer'>
            <div className='footer-content mt-10 w-full grid gap-[80px]'>
                <div className='footer-content-left flex flex-col items-start gap-[70px]'>
                    <div className='header mt-10 text-orange-600'>
                        Caravan
                    </div>
