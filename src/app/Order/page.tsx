...
function PlaceOrder() {
    ...
    return (
        <form className='place-order h-screen flex items-center justify-between gap-[50px] mt-[50px] px-32'>
            ...
            <div className='place-order-right w-full max-w-[max(40%,500px)]'>
                <div className='cart-total flex-1 flex flex-col gap-[20px]'>
                    ...
                    <button className='border-none text-white bg-[tomato] w-[max(100%,200px)] p-[12px 0px] rounded-[4px] mt-[30px]'>PROCEED TO PAYMENT</button>
                </div>
            </div>
        </form>
    )
